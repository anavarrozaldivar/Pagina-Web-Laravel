        ...
        <div class="flex items-start gap-4">
            ...
            <div class="min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Crea y publica un nuevo contenido dentro de la aplicación.
                </p>
            </div>
            ...
            >
                ...
                <div class="p-6 sm:p-8">
                    ...
                    <div class="max-w-3xl space-y-7">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                Define los datos básicos del contenido.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Añade el texto que se mostrará como contenido.
                            </p>
                        ...
                        <div class="border-t border-gray-100 pt-7 dark:border-gray-800">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                Decide si el contenido queda visible o guardado como borrador.
                            </p>
                ...
                <div class="flex flex-col gap-3 border-t border-gray-100 bg-gray-50 px-6 py-5 dark:border-gray-800 dark:bg-gray-800/30 sm:flex-row sm:items-center sm:justify-between sm:px-8">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        Los cambios quedarán registrados al guardar el contenido.
                    </p>
